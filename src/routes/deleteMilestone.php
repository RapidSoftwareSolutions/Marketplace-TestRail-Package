...
$app->post('/api/TestRail/deleteMilestone', function ($request, $response) {
    ...
    $query_str = "https://{$data['appName']}.testrail.io/index.php?/api/v2/delete_milestone/{$data['milestone_id']}";
