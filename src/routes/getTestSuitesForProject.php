...
$app->post('/api/TestRail/getTestSuitesForProject', function ($request, $response) {
    ...
    $query_str = "https://{$data['appName']}.testrail.io/index.php?/api/v2/get_suites/{$data['projectId']}";
