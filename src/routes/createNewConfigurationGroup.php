...
$app->post('/api/TestRail/createNewConfigurationGroup', function ($request, $response) {
    ...
    $query_str = "https://{$data['appName']}.testrail.io/index.php?/api/v2/add_config_group/{$data['projectId']}";
