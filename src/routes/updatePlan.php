...
$app->post('/api/TestRail/updatePlan', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['appName','username','apiKey','planId']);
    ...
    $query_str = "https://{$data['appName']}.testrail.io/index.php?/api/v2/update_plan/{$data['planId']}";
